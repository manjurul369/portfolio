...
export default function ProfileCard() {
  return (
    <div className='relative w-full max-w-[700px] lg:max-w-[350px] flex flex-col items-center py-10 bg-white rounded-2xl overflow-hidden'>
        ...
        <Image src={dashes2} alt="Dashes" className="select-none pointer-events-none absolute top-40 lg:top-90 -left-10" />
        ...
        <p className='text-sm sm:text-lg text-para-black text-center font-medium w-[80%] leading-5 mt-1 max-w-[300px] lg:mt-15'>Data Science & Machine Learning Enthusiasts | Graphic Designer | Full-stack Web Developer | Python</p>
        <div className='flex items-center justify-center gap-5 mt-4'>
            <Link href={'mailto:manjurul.ses.bu@gmail.com'} className=''>
                <div className='hover:bg-gray-200 transition-all duration-300 p-1 rounded-sm'>
                    <MdEmail className='text-2xl text-primary' />
                </div>
            </Link>
            <Link href={'https://github.com/manjurul369'} className=''>
                <div className='hover:bg-gray-200 transition-all duration-300 p-1 rounded-sm'>
                    <AiOutlineGithub className='text-2xl text-primary' />
                </div>
            </Link>
            <Link href={'https://linkedin.com/in/manjurul369'} className=''>
                <div className='hover:bg-gray-200 transition-all duration-300 p-1 rounded-sm'>
                    <FaLinkedin className='text-2xl text-primary' />
                </div>
            </Link>
            <Link href={'tel:+8801767980780'} className=''>
                <div className='hover:bg-gray-200 transition-all duration-300 p-1 rounded-sm'>
